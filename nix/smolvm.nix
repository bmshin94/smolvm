{
  ...
  releases = {
    x86_64-linux = {
      ...
      hash = "sha256-5J5buubWWwOezx2LI20g53Qnt7/RMZB7J6CBn83qP+0=";
    };
    aarch64-linux = {
      asset = "smolvm-${version}-linux-arm64.tar.gz";
      root = "smolvm-${version}-linux-arm64";
      hash = "sha256-B4lak4hIffzOjZ/zO0sKLtBPlrcVTpbuOjzUbuuHy54=";
    };
    aarch64-darwin = {
      asset = "smolvm-${version}-darwin-arm64.tar.gz";
      root = "smolvm-${version}-darwin-arm64";
      hash = "sha256-RLUFc5YrNO6Xm7dKV1a9EFg+IP0dNzm6ooFH0TtaJvM=";
    };
  };
